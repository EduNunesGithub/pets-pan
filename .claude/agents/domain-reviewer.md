...
description: Revisa código contra o modelo de domínio e as regras de negócio de docs/domain.md. Use após implementar ou alterar qualquer coisa que toque organização, animal, case, pipeline, etapa, tarefa, candidatura, adotante, publicação ou arquivamento — e antes de considerar uma feature concluída. Somente leitura: aponta divergências, não corrige.
