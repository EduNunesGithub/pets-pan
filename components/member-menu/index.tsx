      ...
      <Menu.Root>
        ...
        <Menu.Portal>
          <Menu.Positioner align="start" side="top" sideOffset={4}>
            <Menu.Popup className="bg-card border border-line duration-150 ease-out flex flex-col gap-pair min-w-56 origin-bottom p-pair rounded-md shadow-card transition data-ending-style:opacity-0 data-ending-style:scale-95 data-starting-style:opacity-0 data-starting-style:scale-95">
              ...
              <Menu.Item
                className="cursor-pointer flex gap-inset items-center px-inset py-snug rounded-sm text-left text-sm data-highlighted:bg-pine data-highlighted:text-paper"
                onClick={signOut}
              >
